...
% Begin SubSection
\begin{enumerate}[a)]
	\item The purpose this document is to outline the requirements for the \textcolor{blue}{"What is this Beer?"} application. This program will be developed as a mobile android application and will be available on the \underline{Play Store}.
