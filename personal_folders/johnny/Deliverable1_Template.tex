...
\begin{enumerate}
	...
	\item \textcolor{red}{The User will need enough knowledge of smartphone use to be able to download and launch the application.}
...
\begin{enumerate}
	...
	\item \textcolor{red}{Location functionality only works if location is enabled by the client.}
...
\begin{enumerate}
	...
	\item \textcolor{red}{The application depends on the beer database provided by the beer API used.}
...
\begin{enumerate}[{VP}1.]
	...
	\begin{enumerate}[{BE1}.1]
		...
		\item User wants to view general information about beer.
		\begin{enumerate}
			\item
			\item 
			\item 
		...
		\item User wants to request information about a specific beer.
		\begin{enumerate}
			\item
			\item 
			\item 
		...
		\item User wants to review previous searches.
		\begin{enumerate}
			\item
			\item 
			\item 
		...
		\item User wants to sync their social media accounts to the application.
		\begin{enumerate}
			\item
			\item 
			\item 
	...
	\begin{enumerate}[{BE2}.1]
		...
		\item Developer wants to change or swap an expert.
		\begin{enumerate}
