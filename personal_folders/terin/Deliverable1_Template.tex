...
\begin{enumerate}[{VP}1.]
	...
	\begin{enumerate}[{BE1}.1]
		...
		\begin{enumerate}
			...
			\item Below the results chosen by the experts, the forum screen will contain a map of LCBO's and Beer Store's that are located within a 50km radius to the user's current location that offer each type of chosen beer by the experts.
	...
	\begin{enumerate}[{BE2}.1]
		\item LCBO or Beer Store Starts Offering a New Beer
		\begin{enumerate}
			\item 
			\item 
			\item
